<template>
  <div class="picture">
    <div class="leftbar">
      ...
      <el-button size="small" type="primary" class="select" @click="confirm">选中确认</el-button>
    </div>
    <div class="rightbar">
      <div class="rightbar_up">
        <div class="rightbar_up_left" id="swiper">
          ...
          <el-button style="z-index: 99" size="small" type="primary" class="output"
  ...
  methods: {
    ...
    handleSuccess(response, file, fileList) {
      ...
      fileList.forEach((item) => {
        ...
        obj["imgUrl"] = url;
        item = obj;
        this.imgUrlList.push("http://"+item.imgUrl)
      });
      //去重
      this.imgUrlList = Array.from(this.imgUrlList)
      this.height = document.getElementById("swiper").offsetHeight.toString()+'px'
      setTimeout(()=>{
        this.imgShow = ''
      },1000)
    },
